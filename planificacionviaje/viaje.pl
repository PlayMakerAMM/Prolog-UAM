...
%regla para definir el viaje
plan_viajar(Lugar,Presupuesto,Transporte,Alojamiento,Ndias):-
    transporte(Transporte,Lugar,Costo),
    alojamiento(Alojamiento,Lugar,Costo1),
    manutencion(Lugar,Costo2),
    Resta is Presupuesto - Costo, %resta el trasporte con el presupuesto para que no te lo cobre varias veces
